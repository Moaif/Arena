...
public:
	...
	inline static ModuleGameScene* GetScene() {return App->m_scene.get(); };
...
private:
	...
	std::unique_ptr<ModuleGameScene> m_scene = nullptr;
...
#define Scene Application::GetScene()
